"""Phase-3 smoke test: 1-epoch training on a stratified subset for any backbone.

Generalizes scripts/sanity_train_x3d.py. Pick the backbone with --backbone.
Purpose remains: confirm the pipeline runs end-to-end and the loss carries
training signal.
...
def main() -> None:
    ...
    print(
        "  References: uniform-random acc ≈ 0.10, MAE ≈ 3.3, off-by-one ≈ 0.28."
    )
